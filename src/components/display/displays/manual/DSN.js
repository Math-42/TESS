        ...
        this.htmlComponent.innerHTML = `
			<fieldset class="package">
                ...
                <div class="row">
                    ...
                    &nbsp;&nbsp;Well, a lot of information, huh ? But don’t worry, you will get everything with time, now you just need to click on tools and DSN to connect ourselves with the spacecraft. But remember the 7.18 GHz e 7.48 GHz frequency are destructives, you can not use them in the same antenna.</span><br>
                </div>
            </fieldset>
            <fieldset class="package">
